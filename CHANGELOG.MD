...
# 2023-03-24: [UDPST 8.0.0] (https://github.com/BroadbandForum/OB-UDPST/releases/tag/v8.0.0)
...
* Adding GSO (Generic Segmentation Offload) and GRO (Generic Receive Offload) performance optimizations
