...
provided. This change resulted in the supported protocol version range going from 10-10 to 10-11
(i.e., the server will continue to support existing clients, see README for details). In addition,...
